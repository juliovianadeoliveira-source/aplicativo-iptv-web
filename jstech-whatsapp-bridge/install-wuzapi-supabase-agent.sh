...
rm -f "$AGENT_TMP"
curl -fsSL --retry 3 "https://cdn.jsdelivr.net/gh/juliovianadeoliveira-source/aplicativo-iptv-web@f8428dd54e80c163f24f3f226ef54ad6052c0af2/jstech-whatsapp-bridge/wuzapi-supabase-agent.py" -o "$AGENT_TMP" \
|| curl -fsSL --retry 3 "https://raw.githubusercontent.com/juliovianadeoliveira-source/aplicativo-iptv-web/f8428dd54e80c163f24f3f226ef54ad6052c0af2/jstech-whatsapp-bridge/wuzapi-supabase-agent.py" -o "$AGENT_TMP"
