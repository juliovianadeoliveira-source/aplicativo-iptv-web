...
rm -f "$AGENT_TMP"
curl -fsSL --retry 3 "https://cdn.jsdelivr.net/gh/juliovianadeoliveira-source/aplicativo-iptv-web@612e53596ddbad4da6d8b63d66092affce3c4a67/jstech-whatsapp-bridge/wuzapi-supabase-agent.py" -o "$AGENT_TMP" \
|| curl -fsSL --retry 3 "https://raw.githubusercontent.com/juliovianadeoliveira-source/aplicativo-iptv-web/612e53596ddbad4da6d8b63d66092affce3c4a67/jstech-whatsapp-bridge/wuzapi-supabase-agent.py" -o "$AGENT_TMP"
